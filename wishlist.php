  ...
  <tbody>
    <tr>
      ...
      $con = mysqli_connect("localhost","root","","janet & joyce");
		...
		$sql ="SELECT * FROM wishlist INNER JOIN products ON  wishlist.p_id = products.p_id WHERE c_id='".$_SESSION['c_id']."'";	
		$result = mysqli_query($con,$sql);
		if(mysqli_num_rows($result)> 0)
		{
    ...
    <tr>
      <td></td>
      <td><a href="singleproduct.php?p_id=<?php echo $p_id; ?>" style="color: black"><img src="images/<?php echo $p_image; ?>" width="60px" height="" alt=""/></a></td>
      <td><a href="singleproduct.php?p_id=<?php echo $p_id; ?>" style="color: black"><?php echo $p_name; ?></a></td>
