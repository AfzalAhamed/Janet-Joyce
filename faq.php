  ...
  <tbody>
    <tr>
      ...
      <div style="background-color: white; padding: 20px; font-size: 13px">
		<h2>Do you provide free shipping?</h2>
		   <p>Yes, We provide free shipping to our customers</p><br>
		  <h2>Do you accept card payment?</h2>
		   <p>We are soory to tell this, this time we are not accepting any card payment(only cash on delivery). We will be working with that.</p><br>
		  <h2>How meny days it will take to diliverd?</h2>
		   <p>about 2 to 3 day, you can always track your order.</p><br>
		  <h2>Can we return our products?</h2>
		   <p>Yes you can return your product within 7-14 days of period.</p><br>
		  <h2>How to cancel a order?</h2>
		   <p>you can always cancle any order by contacting us.</p><br>
		  <h2>Is this is a trustfull website?</h2>
		   <p> you can trust us  100%.</p><br>
		  </div>
