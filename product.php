...
<table width="100%" border="0">
  <tbody>
    <tr>
      <td width="50%"><h2>Category: <?php echo $_GET['p_category'];?></h2></td>
      <td width="50%" style="float: right; font-size: 14px;"><a href="index.php" class="links">Home</a> / <a href="shop.php" class="links">Products</a> / <?php echo $_GET['p_category'];?></td>
    </tr>
  </tbody>
</table>
