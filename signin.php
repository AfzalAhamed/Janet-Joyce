  ...
  <tbody>
    <tr>
      ...
      <div style="background-color: white; padding: 20px; font-size: 13px">
		  <form class="register" action="signin_post.php" method="post">
		
		  <h2>Sign In</h2>
        
        <input class="input3" type="email" id="txtemail" name="txtemail" placeholder="Email" required><br>
       
        <input class="input3" type="password" id="txtpassword" name="txtpassword" placeholder="Password" required><br>
       
      Don't have an account? <a href="register.php">Register</a>.</p>
		<input class="button2 button1" type="submit" name="btnsignin" id="btnsignin" value="Sign In">
    </form>
